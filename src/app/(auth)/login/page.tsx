                ...
                <div className="bg-white dark:bg-[#111118] border border-slate-200 dark:border-white/8 rounded-3xl p-8 shadow-2xl shadow-slate-200/80 dark:shadow-black/60">
                    ...
                    <div className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-500/8 dark:to-orange-500/8 border border-amber-200 dark:border-amber-500/20">
                        <div className="flex items-start justify-between gap-3">
                            <div>
                                <p className="text-sm font-bold text-amber-700 dark:text-amber-400 mb-1">🚀 Try Demo Account</p>
                                <p className="text-xs text-amber-600 dark:text-amber-500">
                                    Email: <span className="font-mono font-semibold">{DEMO_EMAIL}</span><br />
                                    Pass: <span className="font-mono font-semibold">{DEMO_PASSWORD}</span>
                                </p>
                            </div>
                            <motion.button
                                whileTap={{ scale: 0.96 }}
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 bg-slate-50 dark:bg-white/5 border rounded-xl text-sm text-slate-900 dark:text-white placeholder-slate-400 outline-none transition-all ${
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className={`w-full px-4 py-3 pr-11 bg-slate-50 dark:bg-white/5 border rounded-xl text-sm text-slate-900 dark:text-white placeholder-slate-400 outline-none transition-all ${
