...
export default function FeatureStrips() {
    return (
        <section className="border-y border-slate-200 dark:border-white/5 bg-slate-100 dark:bg-[#0d0d15] transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    {FEATURES.map((f, i) => (
                        ...
                        >
                            <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-xl bg-red-100 dark:bg-red-500/10 text-red-500 dark:text-red-400">
